...
import (
	...
	argov1 "github.com/redhat-developer/gitops-cli/pkg/pipelines/argocd/operator/v1alpha1"
	argoappv1 "github.com/redhat-developer/gitops-cli/pkg/pipelines/argocd/v1alpha1"
	"sigs.k8s.io/yaml"
