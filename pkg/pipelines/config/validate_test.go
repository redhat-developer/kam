...
var validateTests = []struct {
	...
	},
	{
		...
		multierror.Join(
			[]error{
				invalidNameError("my-incredibly-long-name-for-a-test-service-that-fails", longServiceName,
					[]string{"environments.development.apps.app-1.services.my-incredibly-long-name-for-a-test-service-that-fails"}),
			},
		),
	},
	{
...
func matchMultiErrors(t *testing.T, a, b error) error {
	t.Helper()
	if a == nil || b == nil {
		if a != b {
